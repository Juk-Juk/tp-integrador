...
const AddEditAuthorModal = ({ authorSelected, isEdit, isOpen, successCallback, onClose }) => {
    ...
    useEffect(() => {
        ...
        if (createAuthorError) {
            toast.error("Hubo un error al crear el autor.");
        }
        if (!createAuthorError && createAuthorData) {
            toast.success("El autor se creó con éxito.");
            successCallback();
        }
    ...
    useEffect(() => {
        ...
        if (updateAuthorError) {
            toast.error("Hubo un error al editar el autor.");
        }
        if (!updateAuthorError && updateAuthorData) {
            toast.success("El autor se editó con éxito.");
            successCallback();
        }
